...
<meta property="og:image" content="<?php echo HTTP_SERVER . DIR_WS_CATALOG . 'images/' . $products_image; ?>" /> 
<meta property="og:description" content="<?php echo META_TAG_DESCRIPTION; ?>" />
<?php if (FACEBOOK_OPEN_GRAPH_APPID != '') { ?><meta property="fb:app_id" content="<?php echo FACEBOOK_OPEN_GRAPH_APPID; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_ADMINID != '') { ?><meta property="fb:admins" content="<?php echo FACEBOOK_OPEN_GRAPH_ADMINID; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_STREET_ADDRESS != '') { ?><meta property="og:street-address" itemprop="street-address" content="<?php echo FACEBOOK_OPEN_GRAPH_STREET_ADDRESS; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_CITY != '') { ?><meta property="og:locality" content="<?php echo FACEBOOK_OPEN_GRAPH_CITY; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_STATE != '') { ?><meta property="og:region" content="<?php echo FACEBOOK_OPEN_GRAPH_STATE; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_ZIP != '') { ?><meta property="og:postal-code" content="<?php echo FACEBOOK_OPEN_GRAPH_ZIP; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_COUNTRY != '') { ?><meta property="og:country_name" content="<?php echo FACEBOOK_OPEN_GRAPH_COUNTRY; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_EMAIL != '') { ?><meta property="og:email" content="<?php echo FACEBOOK_OPEN_GRAPH_EMAIL; ?>" /><?php } ?>
<?php if (FACEBOOK_OPEN_GRAPH_PHONE != '') { ?><meta property="og:phone_number" content="<?php echo FACEBOOK_OPEN_GRAPH_PHONE; ?>" /><?php } ?>
<meta name="twitter:card" content="summary" />
<?php if (FACEBOOK_OPEN_GRAPH_TWUSER != '') { ?><meta name="twitter:site" content="<?php echo FACEBOOK_OPEN_GRAPH_TWUSER; ?>" /><?php } ?>
...
<meta name="twitter:image" content="<?php echo HTTP_SERVER . DIR_WS_CATALOG . 'images/' . $products_image; ?>" />
