...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        $this->executeInstallerSql(
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ('SuperData version', 'PLUGIN_SUPERDATA_VERSION', '3.0.15', 'Installed version. Check <a href=\"https://github.com/mprough/super_data\" target=\"_blank\" rel=\"noopener\">SuperData on GitHub</a> for the newest release because GitHub updates can appear before Zen Cart Plugin Library approval is complete.', $this->cgi, 0, 'zen_cfg_select_option(array(\'3.0.15\'),'),
    ...
    protected function executeUpgrade(...$args): bool
    {
        ...
        $this->executeInstallerSql("UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '3.0.15', set_function = 'zen_cfg_select_option(array(\'3.0.15\'),' WHERE configuration_key = 'PLUGIN_SUPERDATA_VERSION'");
