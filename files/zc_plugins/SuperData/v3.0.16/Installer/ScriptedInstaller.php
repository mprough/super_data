...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeUpgrade(...$args): bool
    {
        ...
        $this->executeInstallerSql("UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '3.0.16', set_function = 'zen_cfg_select_option(array(\'3.0.16\'),' WHERE configuration_key = 'PLUGIN_SUPERDATA_VERSION'");
