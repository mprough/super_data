...
version_dir='files/zc_plugins/SuperData/v3.0.15'
...
required=(
    ...
    'files/legacy/sql/upgrade_to_3.0.15.sql'
...
grep -Fq "'pluginVersion' => 'v3.0.15'" "$manifest"
...
grep -Fq "'PLUGIN_SUPERDATA_VERSION', '3.0.15'" "$installer"
grep -Fq "array(\'RateTables\', \'Free\', \'FlatRate\')" "$installer"
grep -Fq "define('BOX_CONFIGURATION_SUPER_DATA', 'SuperData v3.0.15')" \
    "$version_dir/admin/includes/extra_datafiles/super_data_menu_name.php"
grep -Fq "define('BOX_CONFIGURATION_SUPER_DATA', 'SuperData v3.0.15')" \
    'files/legacy/YOUR_ADMIN/includes/extra_datafiles/super_data.php'
